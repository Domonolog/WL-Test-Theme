	...
	<div class="wrap about__container">
		...
		<div class="about__section has-1-column">
			...
			<div class="column" style="padding-bottom:0">
				...
				<p>
					<?php _e( 'WordPress 6.0 includes five new template options: author, date, categories, tag, and taxonomy. These additional pages provide greater flexibility for content creators. Tailor each with the tools you already know or with the following new options in this release.' ); ?>
				</p>
			</div>
		</div>
