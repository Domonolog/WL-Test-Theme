...
class Theme_Upgrader extends WP_Upgrader {
	...
	public function check_package( $source ) {
		 ...
		 * - block themes require /pages/index.html or block-pages/index.html (deprecated 5.9.0).
		 */
		if (
			empty( $info['Template'] ) &&
			! file_exists( $working_directory . 'index.php' ) &&
			! file_exists( $working_directory . 'pages/index.html' ) &&
			! file_exists( $working_directory . 'block-pages/index.html' )
		) {
			return new WP_Error(
