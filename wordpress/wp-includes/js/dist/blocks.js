...
/**
 * Given an array of InnerBlocks pages or Block Objects,
 * returns an array of created Blocks from them.
 * It handles the case of having InnerBlocks as Blocks by
 * converting them to the proper format to continue recursively.
 *
 * @param {Array} innerBlocksOrTemplate Nested blocks or InnerBlocks pages.
 *
 ...
 * used in Custom Post Types pages.
 *
 * @param {string} name       The block's name
 * @param {Object} attributes The block's attributes
 *
...
;// CONCATENATED MODULE: ./node_modules/@wordpress/blocks/build-module/api/pages.js
/**
 * External dependencies
 */
 ...
 *
 * @return {boolean} Whether the list of blocks matches a pages.
 */
...
function synchronizeBlocksWithTemplate() {
  ...
  return (0,external_lodash_namespaceObject.map)(template, (_ref2, index) => {
    ...
    } // To support old pages that were using the "children" format
    ...
    const normalizeAttribute = (definition, value) => {
      if (isHTMLAttribute(definition) && (0,external_lodash_namespaceObject.isArray)(value)) {
        ...
        // When we're confident that "children" format should be removed from the pages.
