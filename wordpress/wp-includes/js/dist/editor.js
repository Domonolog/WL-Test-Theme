 ...
 * @property {Array?}        availableTemplates    The available post pages
...
function EntityRecordItem(_ref) {
  ...
  }, []); // Handle pages that might use default descriptive titles.
...
function PageAttributesCheck(_ref) {
  ...
  const supportsPageAttributes = (0,external_lodash_namespaceObject.get)(postType, ['supports', 'page-attributes'], false); // Only render fields if post type supports page attributes or available pages exist.
