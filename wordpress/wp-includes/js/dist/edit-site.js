...
const MENU_TEMPLATES_GENERAL = 'pages-general';
const MENU_TEMPLATES_PAGES = 'pages-pages';
const MENU_TEMPLATES_POSTS = 'pages-posts';
const MENU_TEMPLATES_UNUSED = 'pages-unused';
...
function SiteExport() {
  ...
  return (0,external_wp_element_namespaceObject.createElement)(external_wp_components_namespaceObject.MenuItem, {
    ...
    info: (0,external_wp_i18n_namespaceObject.__)('Download your theme with updated pages and styles.')
...
function TemplateDetails(_ref) {
  ...
  const browseAllLinkProps = useLink({
    ...
    postId: undefined
  }); // Only user-created and non-default pages can change the name.
  ...
  /* translators: the template part's area name ("Headers", "Sidebars") or "pages". */
...
function AddedBy(_ref6) {
  ...
  if (TEMPLATE_POST_TYPE_NAMES.includes(templateType)) {
    ...
    // older customized pages by checking for no origin and a 'theme'
    // or 'custom' source.
    ...
    // was only added to pages in WordPress 5.9. Fallback to showing the
    // site logo and title.
  ...
  } // Simply show the author for pages created from scratch that have an
...
function Table(_ref) {
  ...
  if (!templates.length) {
    ...
    return (0,external_wp_element_namespaceObject.createElement)("div", null, (0,external_wp_i18n_namespaceObject.sprintf)( // translators: The template type name, should be either "pages" or "template parts".
