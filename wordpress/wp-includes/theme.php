 ...
 *
 * Standalone themes need to have a `pages/index.html` or `index.php` template file.
...
function validate_current_theme() {
	...
	if (
		! file_exists( get_template_directory() . '/pages/index.html' )
		&& ! file_exists( get_template_directory() . '/block-pages/index.html' ) // Deprecated path support since 5.9.0.
 ...
 *
 * @since 5.5.0
 * @since 6.1.0 The `block-pages` feature was added.
 */
function create_initial_theme_features() {
	...
	register_theme_feature(
		'block-pages',
		array(
			'description'  => __( 'Whether a theme uses block-based pages.' ),
			'show_in_rest' => true,
		)
	);
	register_theme_feature(
