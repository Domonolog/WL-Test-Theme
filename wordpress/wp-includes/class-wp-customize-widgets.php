...
final class WP_Customize_Widgets {
	...
	public function enqueue_scripts() {
		 ...
		 * since plugins need pages to be in the DOM.
		 */
	...
	/**
	 * Renders the widget form control pages into the DOM.
	 *
	 * @since 3.9.0
	 */
	public function output_widget_control_templates() {
		?>
		<div id="widgets-left"><!-- compatibility with JS which looks for widget pages here -->
