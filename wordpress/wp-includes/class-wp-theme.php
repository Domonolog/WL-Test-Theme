...
final class WP_Theme implements ArrayAccess {
	...
	public function __construct( $theme_dir, $theme_root, $_child = null ) {
		...
		if ( ! $this->template ) {
			...
			if (
				! file_exists( $theme_path . '/pages/index.html' )
				&& ! file_exists( $theme_path . '/block-pages/index.html' ) // Deprecated path support since 5.9.0.
				&& ! file_exists( $theme_path . '/index.php' )
			) {
				$error_message = sprintf(
					/* translators: 1: pages/index.html, 2: index.php, 3: Documentation URL, 4: Template, 5: style.css */
	...
	/**
	 * Returns the theme's post pages.
	 *
	 * @since 4.7.0
	 * @since 5.8.0 Include block pages.
	 *
	...
	public function get_post_templates() {
		...
		if ( ! is_array( $post_templates ) ) {
			...
			if ( current_theme_supports( 'block-pages' ) ) {
	...
	/**
	 * Returns the theme's post pages for a given post type.
	 *
	 * @since 3.4.0
	 * @since 4.7.0 Added the `$post_type` parameter.
	 *
	 * @param WP_Post|null $post      Optional. The post being edited, provided for context.
	 * @param string       $post_type Optional. Post type to get the pages for. Default 'page'.
	...
	public function get_page_templates( $post = null, $post_type = 'page' ) {
		...
		/**
		 * Filters list of page pages for a theme.
		 *
		 * @since 4.9.6
		 *
		 ...
		 * @param string       $post_type      Post type to get the pages for.
		 */
	...
	public function is_block_theme() {
		$paths_to_index_block_template = array(
			$this->get_file_path( '/block-pages/index.html' ),
			$this->get_file_path( '/pages/index.html' ),
		);
