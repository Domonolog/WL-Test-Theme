...
/**
 * Outputs the pages used by playlists.
 *
 * @since 3.9.0
 */
...
function wp_playlist_shortcode( $attr ) {
	...
	if ( 1 === $instance ) {
		/**
		 * Prints and enqueues playlist scripts, styles, and JavaScript pages.
		 *
		 * @since 3.9.0
		 *
...
/**
 * Enqueues all scripts, styles, settings, and pages necessary to use
 * all media JS APIs.
 *
 * @since 3.5.0
 *
